...
function PMCLogoIcon(props) {
    const { fontSize } = props;
    return (
        <SvgIcon fontSize={fontSize} viewBox="0 0 264 230" preserveAspectRatio="xMidYMid meet"> {/*viewBox="0 0 263.89 203.19"*/}
